            ...
            _getfontsDetails(id) {
                ...
                fontDetails(id).then((res) => {
                    if (res.status === 200) {
                        ...
                        if (this.Fontfile.indexOf('kaiti') !== -1) {
                            this.textFont = 'kaiti'
                        } else if (this.Fontfile.indexOf('katong') !== -1) {
                            this.textFont = 'katong'
                        } else if (this.Fontfile.indexOf('lishu') !== -1) {
                            this.textFont = 'lishu'
                        } else if (this.Fontfile.indexOf('tiaotiao') !== -1) {
